                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                @elseif($lowStock > 0)
                                    <span class="badge bg-warning text-dark ms-1" style="font-size:10px;">{{ $lowStock }} low</span>
                                @endif
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="d-flex gap-1">
                                    <a href="{{ route('admin.products.edit', $product) }}" class="btn btn-outline-primary btn-sm p-1" data-pjax title="Edit">
