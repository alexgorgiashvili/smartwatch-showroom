...
@section('content')
@fragment('content')
<div data-page-title="Edit Article">
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        <div><h4 class="mb-3 mb-md-0">Edit: {{ $article->title_en ?: $article->title_ka }}</h4></div>
    ...
    <form method="POST" action="{{ route('admin.articles.update', $article) }}" enctype="multipart/form-data">
        ...
        <div class="d-flex justify-content-end gap-2 mt-3">
            <button type="submit" class="btn btn-primary"><i data-feather="save" style="width:16px;height:16px;"></i> Update Article</button>
        </div>
    </form>
</div>
@endfragment
