    ...
    <div class="d-flex justify-content-between align-items-center flex-wrap grid-margin">
        ...
        <div class="d-flex gap-2">
            <div class="btn-group btn-group-sm" role="group">
                <a href="{{ route('admin.orders.index') }}" class="btn {{ !$paymentStatus ? 'btn-primary' : 'btn-outline-primary' }}" data-pjax>All</a>
            ...
            <a href="{{ route('admin.orders.create') }}" class="btn btn-primary btn-sm d-flex align-items-center gap-1" data-pjax>
                <i data-feather="plus" style="width:16px;height:16px;"></i> New Order
            </a>
        </div>
    </div>
                ...
                <table class="table table-hover table-sm mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('admin.orders.show', $order) }}" class="btn btn-outline-primary btn-sm p-1" data-pjax title="View">
