        ...
        <div class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-2xl border border-rose-200 bg-white p-8 text-center shadow-sm">
                ...
                <div class="mt-6 flex flex-wrap items-center justify-center gap-3">
                    ...
                    <a href="{{ \App\Support\StorefrontUrl::route('products.index') }}" class="inline-flex items-center justify-center rounded-full border border-slate-300 px-5 py-2.5 text-sm font-semibold text-gray-700 hover:border-primary-400 hover:text-primary-600">
