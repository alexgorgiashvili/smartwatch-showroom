      ...
      <div class="bg-white rounded-lg border border-gray-200 p-6">
        ...
        <div class="space-y-4">
          ...
          <div class="flex gap-3">
            ...
            <div>
              <h4 class="font-semibold text-gray-900">კურიერთან ნაღდი ანგარიშსწორება (COD)</h4>
              <p class="text-gray-600 text-sm">კურიერთან ნაღდი ანგარიშსწორება ხელმისაწვდომია მხოლოდ თბილისის შეკვეთებზე. გადახდა ხორციელდება ლარში (GEL), პროდუქტის მიღების მომენტში.</p>
            </div>
          </div>
          <div class="flex gap-3">
            <i class="fas fa-info-circle text-primary-600 flex-shrink-0 mt-1"></i>
            <div>
              <h4 class="font-semibold text-gray-900">ფასები, მიწოდება და ხელმისაწვდომობა</h4>
              <p class="text-gray-600 text-sm">ვებსაიტზე მითითებული ფასები მოცემულია ლარში და შეიძლება შეიცვალოს წინასწარი შეტყობინების გარეშე. მიწოდება უფასოა საქართველოს მასშტაბით. პროდუქტის ხელმისაწვდომობა დამოკიდებულია მარაგზე.</p>
            </div>
          </div>
        </div>
      </div>

      <div class="bg-slate-50 border border-slate-200 rounded-lg p-5 -mt-2">
        <h3 class="text-base font-semibold text-gray-900">მიწოდების სავარაუდო ვადები</h3>
        <ul class="mt-3 list-disc space-y-1 pl-5 text-sm text-gray-600">
          <li>თბილისი: 1 სამუშაო დღე</li>
          <li>რეგიონული ქალაქები: 1-3 სამუშაო დღე</li>
          <li>სოფელი ან დაშორებული მისამართი: 2-5 სამუშაო დღე</li>
          <li>იმავე დღეს მიწოდება მხოლოდ წინასწარი დადასტურების შემთხვევაში</li>
        </ul>
        <p class="mt-3 text-sm text-gray-600">კურიერი, შესაძლებლობის ფარგლებში, წინასწარ დაგიკავშირდებათ მისამართის და ჩაბარების დროის დასაზუსტებლად. თუ მისამართის, სამუშაო დღის ან ლოჯისტიკის გამო დამატებითი გადამოწმება გახდა საჭირო, ჩაბარების ვადა შეიძლება შეიცვალოს.</p>
        <p class="mt-3 text-sm text-gray-600">ორიენტირებისთვის, საქართველოს ფოსტის ოფიციალურ პირობებში აღწერილია, რომ 0-20 კგ გზავნილზე 09:30-15:00-მდე გატანილი გზავნილი შეიძლება იმავე დღეს ჩაბარდეს, ხოლო 15:00-ის შემდეგ - მომდევნო სამუშაო დღეს; სხვადასხვა ადმინისტრაციულ ერთეულებს შორის ვადები კი შესაძლოა 1-5 სამუშაო დღემდე მერყეობდეს. ეს ინფორმაცია გამოყენებულია მხოლოდ სავარაუდო ვადების განსასაზღვრად და არ წარმოადგენს ყველა შეკვეთაზე ზუსტი ჩაბარების გარანტიას.</p>
      </div>
        ...
        <div class="space-y-4">
          <div class="bg-green-50 border border-green-200 rounded-lg p-4">
            <div class="flex gap-3">
              ...
              <div>
                <h4 class="font-semibold text-gray-900">გარანტია მოდელის ტიპის მიხედვით</h4>
                <p class="text-gray-600 text-sm">MyTechnic-ში შეძენილ 2G მოდელებზე მოქმედებს 1 (ერთი) თვის გარანტია, ხოლო 4G მოდელებზე 3 (სამი) თვის გარანტია, შეძენის დღიდან. გარანტია ფარავს ქარხნულ დეფექტებს და ტექნიკურ გაუმართაობას, რომელიც არ არის გამოწვეული მომხმარებლის მიერ.</p>
              </div>
            </div>
          </div>
          <div class="bg-gray-50 rounded p-4 space-y-2">
