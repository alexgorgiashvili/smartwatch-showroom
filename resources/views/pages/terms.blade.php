          ...
          <div class="bg-green-50 border border-green-200 rounded-lg p-4">
            <div class="flex gap-3">
              ...
              <div>
                ...
                <p class="text-gray-600 text-sm">MyTechnic-ში შეძენილ 2G მოდელებზე მოქმედებს 3 (სამი) თვის გარანტია, ხოლო 4G მოდელებზე 6 (ექვსი) თვის გარანტია, შეძენის დღიდან. გარანტია ფარავს ქარხნულ დეფექტებს და ტექნიკურ გაუმართაობას, რომელიც არ არის გამოწვეული მომხმარებლის მიერ.</p>
              </div>
            </div>
          </div>
          <div class="bg-gray-50 rounded p-4 space-y-2">
