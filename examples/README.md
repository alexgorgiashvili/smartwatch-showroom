...
echo ""
echo "9. Windows PowerShell local tests:"
echo "   powershell -ExecutionPolicy Bypass -File .\\meta-local-test.ps1 -Mode verify"
echo "   powershell -ExecutionPolicy Bypass -File .\\meta-local-test.ps1 -Mode facebook"
echo "   powershell -ExecutionPolicy Bypass -File .\\meta-local-test.ps1 -Mode instagram"
echo ""
