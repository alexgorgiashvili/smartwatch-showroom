    ...
    private function seedFaqDocuments(): void
    {
        $documents = [
            [
                'key' => 'faq-shipping',
                'type' => 'faq',
                'title' => 'უფასო მიწოდება მთელი ქვეყნის მასშტაბით',
                'content_ka' => "მიწოდება უფასოა მთელი ქვეყნის მასშტაბით და ხდება შეკვეთის გაფორმებიდან მოკლე ვადაში.\n\nკურიერი წინასწარ დაგიკავშირდებათ და დაგიზუსტებთ მისამართს და მისვლის სავარაუდო დროს, რათა ზედმეტად არ მოგიწიოთ ლოდინი.",
            ...
            [
                'key' => 'faq-returns',
                'type' => 'faq',
                'title' => 'მოდელის გაცვლა და საგარანტიო საკითხები',
                'content_ka' => "მხოლოდ მოდელის გაცვლა შესაძლებელია მიღებიდან 14 კალენდარული დღის განმავლობაში, თუ პროდუქტი არ არის გამოყენებული, აქვს ორიგინალური შეფუთვა და თან ახლავს ყიდვის დამადასტურებელი დოკუმენტი.\n\nქარხნული წუნის შემთხვევაში მოქმედებს შესაბამისი საგარანტიო პირობა. დაბრუნების ან გაცვლის მოთხოვნისთვის დაგვიკავშირდით მხარდაჭერის არხზე.",
                'metadata' => ['category' => 'გარანტია და დაბრუნება'],
            ],
            [
                'key' => 'faq-gps',
